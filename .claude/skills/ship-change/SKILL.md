---
name: ship-change
description: Disciplined change procedure — understand, implement, test, inspect diff, review, report. Prevents claiming a task is done before it has actually been verified. Use for any non-trivial code change in this repository, or when invoked directly as /ship-change.
---

# /ship-change — Disciplined Change Procedure
...
For non-trivial changes, delegate this step to the `final-reviewer` subagent instead of self-reviewing.
